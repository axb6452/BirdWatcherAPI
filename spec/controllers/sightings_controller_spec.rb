  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Sighting" do
        expect {
          post :create, params: {sighting: valid_attributes}, session: valid_session
      ...
      it "renders a JSON response with the new sighting" do
        ...
        expect(response.location).to eq(sighting_url(Sighting.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the sighting" do
        ...
        put :update, params: {id: sighting.to_param, sighting: valid_attributes}, session: valid_session
